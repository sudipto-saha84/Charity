    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{ asset(auth()->user()->image ?? 'assets/img/avatar5.png') }}" class="img-circle"
                    alt="User Image" />
            </div>
            <div class="pull-left info">
                <p>Hello, {{ explode(' ', trim(auth()->user()->name))[0] }}</p>
...
{{--                    <li class=""><a href="{{route('home.users.add-slider')}}"><i--}}
{{--                                class="fa fa-angle-double-right"></i>Add Slider</a>--}}
{{--                    </li>--}}

{{--                    <li class="">--}}
{{--                        <a href="{{route('home.users.slider-manage')}}">--}}
{{--                            <i class="fa fa-angle-double-right"></i> Manage Slider--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--            @endrole--}}
            ...
            @role('Admin')
                        <li class="{{ set_active('home/users/contact-show') }}">
                            <a href="{{ route('home.contactShow') }}">
                                <i class="fa fa-angle-double-right"></i> Messages
                            </a>
                        </li>
                    @endrole
...
{{-- <!-- chat item --> --}}
{{-- <div class="item"> --}}
{{-- <img src="{{asset('assets/img')}}/avatar.png" alt="user image" class="online"/> --}}
{{-- <p class="message"> --}}
{{-- <a href="#" class="name"> --}}
...
{{-- <!-- chat item --> --}}
{{-- <div class="item"> --}}
{{-- <img src="{{asset('assets/img')}}/avatar2.png" alt="user image" class="offline"/> --}}
{{-- <p class="message"> --}}
{{-- <a href="#" class="name"> --}}
...
{{-- <!-- chat item --> --}}
{{-- <div class="item"> --}}
{{-- <img src="{{asset('assets/img')}}/avatar3.png" alt="user image" class="offline"/> --}}
{{-- <p class="message"> --}}
{{-- <a href="#" class="name"> --}}
