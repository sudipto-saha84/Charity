                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{ route('home.events.store') }}" method="POST"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="image">Event Pictures</label>
                                <input type="file" id="image" class="form-control" name="images[]" accept="image/*" multiple>
                                @error('images')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                             ...
                             <div class="form-group">
                                ...
                                <input type="url" id="title" name="video" class="form-control" placeholder="Video"
                                    required />
                                @error('video')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
