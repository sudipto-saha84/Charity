...
<div class="section-home our-causes animate-onscroll fadeIn">
    ...
    <div class="container">
        ...
        <div class="row">
            @foreach ($events as $event)<a href="{{ route('eventsDetail',$event->id) }}">
            <div class="col-md-3 col-sm-6">

                    <div class=" cause">

                <img src="{{ asset($event->image) }}" alt="{{ $event->title }}" style="height: 15rem;"
                    class="cause-img img-fluid">

                <div STYLE="height: 28rem;">


                    <h4 class="cause-title">{{ $event->title }} </h4>
                    <div class="cause-details">
...
<div class="section-home our-causes animate-onscroll fadeIn">
    ...
    <div class="container">
        ...
        <div class="row">
            @foreach (\App\Models\User::where('donation', '!=', '0')->orderBy('donation',
            'DESC')->take(4)->get() as $index => $user)
            <div class="col-md-3 col-sm-6">

                <div class="cause">

                    <img src="{{ asset($user->image ?? 'assets/img/user.png') }}" alt="{{ $user->name }}"
                        class="cause-img" style="height: 300px;width:100%">
                    ...
                    <div class="cause-details">
                        {{ Str::limit(donationQuate($index),70,'...') }}
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="footer-col">
                        ...
                        <div class="footer-content">
                            ...
                            <p>
                                <strong>DIU</strong> ipsum dolor sit amet, consectetur adipiscing elit. Ut at eros
...
@csrf
    ...
    <div class="footer-bottom">
        ...
        <div class="container text-right">
            Charity @ copyrights 2022 - by <a href="" target="_blank">DIU</a>
        </div>
    </div>
...
@if (Session::has('get-role-access'))
<div class="modal fade" id="get-role-access" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card m-5">
                    ...
                    <div class="card-body">
                        <a href="{{route('home.get-role-access',['role'=>'Volunteer'])}}"
                            class="btn btn-success-outline">Join As
                            Volunteer</a>
                        <a href="{{route('home.get-role-access',['role'=>'Donor'])}}"
                            class="btn btn-success-outline">Join As
                            Donor</a>
                    </div>
                </div>
...
<script>
    window.jQuery || document.write('<script src="{{ asset('assets/js/jquery-1.11.1.min.js') }}">
</script>')
</script>
...
<script>
    swal('{{ Session::get('accept-success') }}');
</script>
@endif
...
@if (Session::has('get-role-access'))
<script>
    $('#get-role-access').modal("show")
    swal("{{Session::get('get-role-access')}}");
</script>
@endif
